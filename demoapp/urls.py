...
from demoapp.EditResultView import EditResultView
...
urlpatterns = [
    ...
    path('videofile',staff_views.staff_video_add,name="staff_video_add"),
    path("videofile/delete", staff_views.staff_video_edit, name='staff_video_edit'),
    path('doc',staff_views.staff_doc_add,name="staff_doc_add"),
    path('doc/view',staff_views.staff_doc_edit,name="staff_doc_edit"),
     path('sdel<int:usersid>',staff_views.ddeletes,name="dle"),
      path('del<int:userid>',staff_views.deletes,name="dl"),
    ...
    path("video/view", student_views.student_video_view, name='student_video_view'),
    path('doc/views',student_views.student_doc_view,name="student_doc_view"),
    path('course',views.courselist,name="c"),
    path('tea',views.teacherslist,name="t"),
    path('about',views.aboutus,name="a"),
    path('news',views.newss,name="n"),
